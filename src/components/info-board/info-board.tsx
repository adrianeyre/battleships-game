...
const InfoBoard: FC<IInfoBoardProps> = (props: IInfoBoardProps) => {
  ...
  const handlePlayerNameUpdate = (event: ChangeEvent<HTMLInputElement>): void =>
    ...
    <div className="info-board" style={styleInfoBoard()}>
      ...
      <div className="info-board-instructions">
        <p>
          ...
          vertically or horizontally. Diagonal placement is not allowed. No part of a ship may hang
          off the edge of the board. Ships may not overlap each other. No ships may be placed on
          another ship. Once the guessing begins, the players may not move the ships.
        </p>
        <table>
          <tbody>
            <tr>
