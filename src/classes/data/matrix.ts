...
const matrixData: IMatrices[] = [
  ...
  },
  {
    ...
    images: [
      [
        [
          ImageEnum.HORIZONTAL_LEFT,
          ImageEnum.HORIZONTAL,
          ImageEnum.HORIZONTAL,
          ImageEnum.HORIZONTAL_RIGHT,
        ],
        [
          ImageEnum.BAD_HORIZONTAL_LEFT,
          ImageEnum.BAD_HORIZONTAL,
          ImageEnum.BAD_HORIZONTAL,
          ImageEnum.BAD_HORIZONTAL_RIGHT,
        ],
      ],
      [
        [ImageEnum.VERTICAL_UP, ImageEnum.VERTICAL, ImageEnum.VERTICAL, ImageEnum.VERTICAL_DOWN],
        [
          ImageEnum.BAD_VERTICAL_UP,
          ImageEnum.BAD_VERTICAL,
          ImageEnum.BAD_VERTICAL,
          ImageEnum.BAD_VERTICAL_DOWN,
        ],
      ],
    ],
  },
  {
    ...
    images: [
      ...
      [
        [
          ImageEnum.VERTICAL_UP,
          ImageEnum.VERTICAL,
          ImageEnum.VERTICAL,
          ImageEnum.VERTICAL,
          ImageEnum.VERTICAL_DOWN,
        ],
        [
          ImageEnum.BAD_VERTICAL_UP,
          ImageEnum.BAD_VERTICAL,
